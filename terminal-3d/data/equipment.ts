...
import { TankData, PipeData, ValveData, LoadingAreaData } from "../js/database/inMemoryDb"; // Importar interfaces
...
// Definir o tipo para o objeto exportado
...
export const EquipmentData: InitialEquipmentData = {
    /**
     * Dados dos tanques
     */
    tanks: [
